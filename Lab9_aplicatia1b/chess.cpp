/*
 *  Programul reia programul "checker.cpp" dar cu valori pentru coordonatele de texturare cuprinse intre 0 si 3
 *  in conditiile in care se pastreaza parametrul GL_CLAMP
 */
#include "glos.h"
